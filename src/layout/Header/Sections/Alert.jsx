  ...
  return (
    <div className="absolute top-full right-0 mt-2 w-[400px] text-center bg-gray-300 rounded-lg">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            <div className="flex flex-col text-left">
              <li className="text-[16.5px] font-bold">
                (userId)님이 거래에 참여했습니다.
              </li>
            </div>
          </div>
      ...
      <ul className="flex flex-col m-3 mx-3 p-4 rounded-md bg-white">
        ...
        <div className="mt-2">
          <button className="text-[10px] p-1 mr-1 rounded-md bg-[#2B0585] text-white">
            제안 수락
          </button>
          <button className="text-[10px] p-1 rounded-md bg-[#2B0585] text-white">
            제안 거절
          </button>
        </div>
      </ul>
